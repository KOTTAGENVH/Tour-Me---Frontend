...
import SriLankaCarousel from "../../Resources/SriLankaCarousel.jpeg";
    ...
    <div>
      ...
      >
        ...
        <img
          ...
          style={{ width: "80%", height: "60vh", backgroundSize: "cover", borderRadius: "20px" }}
        />
...
Due to its location in the path of major sea routes, Sri Lanka is a strategic naval link between West Asia and South East Asia, and has been a center of Buddhist religion and culture from ancient times.
...
After over two thousand years of rule by local kingdoms, parts of Sri Lanka were colonized by Portugal and the Netherlands beginning in the 16th century, before the control of the entire country was ceded to the British Empire in 1815.
...
During World War II, Sri Lanka served as an important base for Allied forces in the fight against the Japanese Empire. A nationalist political movement arose in the country in the early 20th century with the aim of obtaining political independence, which was eventually granted by the British after peaceful negotiations in 1948.
        ...
        <span>&copy; Note: Image and text taken from Sri-Lankan High Commission in Pakistan(Website). Link: https://www.slhcpakistan.org/discover-sri-lanka-wonder-of-asia/</span>
      </Box>
      <Footer />
    </div>
  );
